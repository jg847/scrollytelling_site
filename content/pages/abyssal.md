...
The water column ends. The seafloor begins. *Abyssal* comes from the Greek *abyssos* — bottomless — which is wrong, but it didn't feel wrong to anyone before sonar. Below 4,000 meters, you're standing on the single largest landscape on Earth: the **abyssal plain**.
...
In **1977**, the submersible *Alvin* descended to the Galápagos Rift expecting more of the same — sparse, slow, mud. Instead it found dense forests of red-tipped tubeworms, swarms of crabs, and clams the size of dinner plates, all clustered around cracks in the seafloor where 350 °C water was pouring out.

It rewrote biology. Every ecosystem on Earth, as far as anyone knew, ultimately ran on sunlight. These didn't. The base of this food web was bacteria using **sulfur and methane** from the vent water as an energy source — a process called **chemosynthesis**. Life here doesn't need the sun at all.

```timeline
1977 | Alvin discovers tubeworm colonies at the Galápagos Rift
1977 | The first specimens reach the surface — biology textbooks need rewriting
1979 | First "black smoker" chimney photographed at 21°N on the East Pacific Rise
1980s | Chemosynthesis confirmed as the base of the food web
Today | Hundreds of vent fields catalogued; new species on most expeditions
```
